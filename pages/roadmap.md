...
* [<s>Additional header with text</s>]({{ '/headers/' | absolute_url }})
...
* [<s>Step-by-Step-Guide to customize *Feeling Responsive*</s>]({{ '/getting-started/' | absolute_url }})
* [<s>Video-Post-Format to feature videos in a huge way</s>]({{ '/design/video/' | absolute_url }})
...
* [<s>Gallery Post Example</s>]({{ '/design/gallery/' | absolute_url }})
